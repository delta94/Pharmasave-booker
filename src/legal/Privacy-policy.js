...
const PrivacyPolicy = () => {
    return (
        <div className='container'>
            <h1>Pharmasave Carriage Crossing Pharmacy Booker Privacy Policy</h1>
            <h2>A: Introduction</h2>
            <ol className="list-styled">
                <li>Definitions: In this Privacy Policy (the “Privacy Policy”), the terms “you”, and “your” refer to our customers, website visitors and application users. The term “we”, “our” and “us” refer to the Pharmasave franchisee Carriage Crossing Pharmacy</li>
            ...
            <ul class="list-styled">
                Profile Information: If you register with our website or any of our applications, specifically the Pharmasave Carriage Crossing Pharmacy Booker, you will receive a password and account designation when you have completed the profile information. You agree to provide true, accurate and complete information about yourself. You are responsible for managing your account, including but not limited to maintaining the confidentiality of passwords and/or any of your account information. You are also responsible for maintaining and promptly updating your account information to keep it true, accurate, current and complete. You are responsible for all activities that occur under your password or on your account. Any person who has access to your account credentials may be able to access any of the personal information available in your account, including if you share your account credentials with a health care provider.
            </ul>
            <h2>B: Scope and Application</h2>
            <ol className="list-styled">
            ...
            <h3>GENERAL</h3>
            <ol className="list-styled">
                <li>We use your information to provide you with health information, tools and resources, to administer and build your account with us, to market new products or services that we believe will be of interest to you, for general research and opinion studies, or as required or authorized by law. We also use the information collected to monitor and improve our internal programs and operations. We may copy, distribute, display, transmit, prepare derivative works from or otherwise use the information only in accordance with this Privacy Policy, as required or permitted by applicable laws, and as directed by you.</li>
            ...
            <h2>D: Correcting Personal Information</h2>
            ...
            <h2>E: Principles</h2>
            <p>To demonstrate our commitment to your privacy, we adhere to the following principles derived from the <b>PERSONAL INFORMATION PROTECTION AND ELECTRONIC DOCUMENTS ACT (Canada):</b></p>
            ...
            <hr/>
            <br/>
            <p>Policy last updated: April 2020</p>
        </div>
    );
}
