        ...
        contact: (
            <div className="col-lg-3 col-md-3 col-sm-12">
                ...
                <ul className="list-unstyled">
                    ...
                    <li>
                        <a href="https://goo.gl/maps/jABcwNoBWiG9ahBo6" target="_blank" rel="noopener"><span className="material-icons">business</span>  105 Oak Park Dr #4, Waterloo, ON N2K 0B3</a>
                    </li>
                </ul>
            </div>
        ),
